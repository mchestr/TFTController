...
TFTKeyboard::TFTKeyboard(MiniGrafx* gfx, const char* titleFont, const char* keyboardFont)
    : gfx(gfx), titleFont(titleFont), keyboardFont(keyboardFont) {}

TFTKeyboard::~TFTKeyboard() {}

void TFTKeyboard::setDefaultValue(String value) {
  this->buffer = value;
}
